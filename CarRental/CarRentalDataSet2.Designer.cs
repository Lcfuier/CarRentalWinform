...
namespace CarRental {
    ...
    public partial class CarRentalDataSet2 : global::System.Data.DataSet {
        ...
        public partial class ReturnCarDataTable : global::System.Data.TypedTableBase<ReturnCarRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ReturnCarRow AddReturnCarRow(System.DateTime StartDate, System.DateTime EndDate, int RentalFee, System.DateTime ReturnDate, int FineDelay, int TotalAmount, CarRow parentCarRowByFK_Car_Return, CustomerRow parentCustomerRowByFK_Customer_Return, int UserId) {
...
namespace CarRental.CarRentalDataSet2TableAdapters {
...
SELECT Id, Brand, Model, StatusCar, Price FROM Car WHERE (Id = @Id)";
        ...
        public virtual int Fill(CarRentalDataSet2.CarDataTable dataTable) {
        ...
        public virtual CarRentalDataSet2.CarDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarRentalDataSet2.CarDataTable dataTable = new CarRentalDataSet2.CarDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarRentalDataSet2.CarDataTable dataTable) {
...
SELECT Id, FullName, Addr, PhoneNumber FROM Customer WHERE (Id = @Id)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(CarRentalDataSet2.CustomerDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual CarRentalDataSet2.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarRentalDataSet2.CustomerDataTable dataTable = new CarRentalDataSet2.CustomerDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarRentalDataSet2.CustomerDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
...
SELECT Id, StartDate, EndDate, RentalFee, CarId, CustomerId FROM Rental WHERE (Id = @Id)";
    ...
    public partial class ReturnCarTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[ReturnCar] ([StartDate], [EndDate], [RentalFee], [ReturnDate], [FineDelay], [TotalAmount], [CarId], [CustomerId], [UserId]) VALUES (@StartDate, @EndDate, @RentalFee, @ReturnDate, @FineDelay, @TotalAmount, @CarId, @CustomerId, @UserId);
SELECT Id, StartDate, EndDate, RentalFee, ReturnDate, FineDelay, TotalAmount, CarId, CustomerId, UserId FROM ReturnCar WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@StartDate", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "StartDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@EndDate", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "EndDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@RentalFee", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "RentalFee", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ReturnCar] SET [StartDate] = @StartDate, [EndDate] = @EndDate, [RentalFee] = @RentalFee, [ReturnDate] = @ReturnDate, [FineDelay] = @FineDelay, [TotalAmount] = @TotalAmount, [CarId] = @CarId, [CustomerId] = @CustomerId, [UserId] = @UserId WHERE (([Id] = @Original_Id) AND ((@IsNull_StartDate = 1 AND [StartDate] IS NULL) OR ([StartDate] = @Original_StartDate)) AND ((@IsNull_EndDate = 1 AND [EndDate] IS NULL) OR ([EndDate] = @Original_EndDate)) AND ((@IsNull_RentalFee = 1 AND [RentalFee] IS NULL) OR ([RentalFee] = @Original_RentalFee)) AND ((@IsNull_ReturnDate = 1 AND [ReturnDate] IS NULL) OR ([ReturnDate] = @Original_ReturnDate)) AND ((@IsNull_FineDelay = 1 AND [FineDelay] IS NULL) OR ([FineDelay] = @Original_FineDelay)) AND ((@IsNull_TotalAmount = 1 AND [TotalAmount] IS NULL) OR ([TotalAmount] = @Original_TotalAmount)) AND ((@IsNull_CarId = 1 AND [CarId] IS NULL) OR ([CarId] = @Original_CarId)) AND ((@IsNull_CustomerId = 1 AND [CustomerId] IS NULL) OR ([CustomerId] = @Original_CustomerId)) AND ((@IsNull_UserId = 1 AND [UserId] IS NULL) OR ([UserId] = @Original_UserId)));
SELECT Id, StartDate, EndDate, RentalFee, ReturnDate, FineDelay, TotalAmount, CarId, CustomerId, UserId FROM ReturnCar WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@StartDate", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "StartDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@EndDate", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "EndDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@RentalFee", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "RentalFee", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, StartDate, EndDate, RentalFee, ReturnDate, FineDelay, TotalAmount, Car" +
                "Id, CustomerId, UserId FROM dbo.ReturnCar";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(CarRentalDataSet2.ReturnCarDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual CarRentalDataSet2.ReturnCarDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarRentalDataSet2.ReturnCarDataTable dataTable = new CarRentalDataSet2.ReturnCarDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarRentalDataSet2.ReturnCarDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        public virtual int Update(
                    ...
                    string Original_CustomerId, 
                    global::System.Nullable<int> Original_UserId) {
            return this.Update(StartDate, EndDate, RentalFee, ReturnDate, FineDelay, TotalAmount, CarId, CustomerId, UserId, Original_Id, Original_StartDate, Original_EndDate, Original_RentalFee, Original_ReturnDate, Original_FineDelay, Original_TotalAmount, Original_CarId, Original_CustomerId, Original_UserId, Original_Id);
        }
    }
...
SELECT id, Fullname, Username, PassWordHash, Roles, UserStatus, Salt FROM Users WHERE (id = @id)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(CarRentalDataSet2.UsersDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual CarRentalDataSet2.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarRentalDataSet2.UsersDataTable dataTable = new CarRentalDataSet2.UsersDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarRentalDataSet2.UsersDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
